...
/// @title Registro de evidencias digitales para procesos de análisis forense
/// @notice Registra hashes; no almacena el archivo original de la evidencia.
contract RegistroEvidenciasForenses {
    ...
    function verificarEvidencia(
        ...
        evidenciaCoincide =
            evidencia.existe && evidencia.evidenciaHash == evidenciaHash;
    }
