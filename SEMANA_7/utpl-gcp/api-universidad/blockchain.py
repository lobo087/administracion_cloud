...
def get_web3() -> Web3:
    rpc_url = os.getenv("BLOCKCHAIN_RPC_URL", "http://geth-utpl:8545")
...
def get_private_key() -> str:
    private_key = os.getenv("UNIVERSIDAD_PRIVATE_KEY") or os.getenv("GANACHE_PRIVATE_KEY")

    if not private_key:
        raise RuntimeError("Falta configurar UNIVERSIDAD_PRIVATE_KEY")
